# crypTokyo
<img width="1200" alt="Screenshot 2024-11-27 at 18 45 32" src="https://github.com/user-attachments/assets/1bd1461a-401f-4947-bb22-53b4072512e3">


## Overview 📝
crypTokyoは、暗号学や経済学の分野の研究者や関係者が共同で生活できるシェアハウスです。シェアハウスを通じて研究のアイデアや開発を促進し、Ethereumに貢献することを目的としています。

主な活動は以下の通りです
- シェアハウス運営
- イベント運営 / 月1回、計12回
- シェアハウスは2024年1月から12月までの1年間営業予定です


## Purpose 🧭
暗号と経済に関わる研究者が共生できる環境を作り、創発的な交流からイノベーションを生み出すことを目的としています。日本には暗号と経済に関わる研究者や技術者は多くいますが、横のつながりが少なく、オフラインで議論する機会も少ないです。同様に、非日本語圏の研究者や技術者も多くいますが、こちらも横のつながりが少ないです。専門性の高い人同士の横のつながりや暗号と経済領域の風​​通しを良くすることで、イノベーションを促進することができます。Ethereumを始めとするブロックチェーンという技術は暗号と経済の知識を軸に構築されているため、暗号と経済が交差する空間を作ることは、分野への貢献に有益であると考えます。

## What We Are Not 🚧
- 私たちは大規模なパーティーを主催することを好まず、少人数のグループが集まり、有意義な会話ができる空間として維持するよう努めます。
...
- 研究ハウスがある間は、いつでも訪問/宿泊可能
- イベントの共催
- イベント内でライトニングトーク枠の獲得
- ハウス/イベントに関連するページでロゴ掲載（イベント参加ページやハウスの公式ページなど）
- ハウス内にスワッグや資料の掲載

私たちの取り組みに賛同し、私たちのスポンサーを希望していただける方は、以下のいずれかを通じてご連絡をお願いいたします。
...
- [Progcrypto Camp](https://lu.ma/1rg8psb1): 暗号技術に取り組む人のために4日間の合宿です。期間中は初学者向けのワークショップや各分野の研究者によるセッションを用意し、また、各自が能動的にトピックや課題を共有できる空間を提供しました。
